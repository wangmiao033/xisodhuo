...
var c = t("Const"),
    ...
    e =
        ...
        (O.prototype.loadObjectReq = function () { this.set_load_object_req = !0; }),
        (O.prototype.loadObjects = function (t) { void 0 === t && (t = null), M.default.getInstance().updateLoadObjects(); }),
        (O.prototype.createByLocalData = function (t, e) {
            !t || ((e = s.default.createByLocalData(t, e)).objectState == c.ObjectState.none &&
        ...
        (O.prototype.addObject = function (t, e, o) {
            ...
            this.mapObject[e.getUID()]
                ...
                : n.loadObject(function () { i._addObject(t, e, o); });
        }),
        (O.prototype._addObject = function (t, e, o) {
            if (this.mapObject[e.getUID()]) cc.error("请勿重复添加对象", e);
                ...
                (a.prefab = t), (a.objectID = e.objectID), (a.data = e),
                (this.mapObject[e.getUID()] = a), (i.parent = n), (i.active = !0),
                a.initMapPos(e.posSys);
                if (e.objectID == c.SpecialObjectID.mainHouse) {
                    this.mainHouse = a;
        ...
        (O.prototype.setTempObjectData = function (t) { this.tempObjectData = t; }),
        ...
        (O.prototype.removeMapObject = function (t) {
            this.obstacleData.removeMapObstacle(this._mapObjectDatas[t].getUnCrossGrid()),
                (this._mapObjectDatas[t] = null), delete this._mapObjectDatas[t],
                this.mapObject[t].node.destroy(), delete this.mapObject[t],
        ...
        (O.prototype.openHouse = function () { var t = this.mainHouse.getComponent(r.default); t && t.open(); }),
        (O.prototype.collect = function (t) {
            var e = this.liftMapObjectDatas[t];
            e && (p.gm.localData.addToCollect(t, {x:e.getWorldGrid().x,y:e.getWorldGrid().y,objectID:e.objectID,lv:e.lv}),
                this.liftMapObject[t].node.destroy(), delete this.liftMapObject[t], delete this.liftMapObjectDatas[t],
                p.gm.localData.removeMapObjectData(t));
        }),
        (O.prototype.getObjectData = function (t) { return this._mapObjectDatas[t]; }),
        (O.prototype.getAllObjectDatas = function () { return this._mapObjectDatas; }),
